...
if (isset($_POST['userID'])) {
	if (events::validateEvents($_POST)) {
        $event_id = events::addEvents($_POST);
        ...
        if (isset($_POST['img_url'])) {
            events::attachPhotoUrl($event_id, $_POST['img_url']);
        }
		successMessage("Event added ", 'viewEvent.php?event_id='.$event_id);
		die(0);
	}
} else {
...
<div class="col-md-8"><h2>Add Event</h2>
<form name="addEvent" class='form-horizontal' enctype="multipart/form-data" method='post' id="formAddEvent" action=""><fieldset>
	<div class='form-group'>
		...
		<input type="text" id="title" name="title" maxlength="150" class="form-control" value="<?php echo htmlentities($events['title']); ?>">
	</div>
	   <div class='form-group'>
...
<?php echo htmlentities($events['description']); ?>
    ...
    <div class='form-group'>
		<button type="submit" class="btn btn-primary" name="btnSubmit" id="btnSubmit">Add Event</button>
